 ...
 * IN THE SOFTWARE.
 */
window["FusionVersion"] = "Clickteam Fusion HTML5 Exporter Build 284.3";
...
function CRunApp(cName, cfile, path, sub)
{
	...
	var cont = this.container = document.createElement('div');
...
CRunApp.prototype =
	{
		...
		load: function ()
		{
			...
			var filePath = this.resources + this.currentFile.toString() + this.path.replace(this.resources, '');
		...
		resizeCanvas: function ()
		{
			...
			if (this.dwOptions & CRunApp.AH2OPT_KEEPSCREENRATIO)
			...
			if (this.playApplication(false))
			{
				...
				else
				{
					if (this.preloader == null)
					{
						...
						if (this.parentApp == null)
						{
							if (this.frame.leClearBackground) this.context.clearBackground(0, 0, this.canvas.width, this.canvas.height);
							else this.context.renderSolidColor(0, 0, this.gaCxWin, this.gaCyWin, this.frameColor);
