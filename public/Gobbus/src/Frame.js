...
CBackInstance.prototype =
{
	draw:        function (context, xx, yy)
	{
		if (this.levelObject != null)
		{
			...
			{
				context.renderImage(this.imageUsed, xx + this.x + this.imageUsed.xSpot, yy + this.y + this.imageUsed.ySpot, 0, 1.0, 1.0, this.poi.oiInkEffect, this.poi.oiInkEffectParam);
			}
			else
			{
		...
		{
			context.renderImage(this.imageUsed, xx + this.x, yy + this.y, 0, 1.0, 1.0, 0, 0);
		}
	},
