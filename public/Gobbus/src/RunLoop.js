...
CRun.prototype =
{
	...
	{
	    if (pObject.hoCommon.ocIdentifier == CRun.FANIDENTIFIER || pObject.hoCommon.ocIdentifier == CRun.TREADMILLIDENTIFIER || pObject.hoCommon.ocIdentifier == CRun.MAGNETIDENTIFIER)
		{
			var pOL=0;
			var nObjects;
			for (nObjects = 0; nObjects < this.rhNObjects; pOL++, nObjects++)
